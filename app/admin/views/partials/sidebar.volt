  ...
  <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
    <ul class="navbar-nav flex-column">
      ...
      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#production" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="production">
          <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fab fa-product-hunt"></span></span><span>Production</span></div>
        </a>
      ...
      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#setcards" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="setcards">
            <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-copy"></span></span><span>Card Types</span></div>
          </a>
          <ul class="nav collapse" id="setcards" data-parent="#navbarVerticalCollapse">
            <li class="nav-item"><a class="nav-link" href="{{url('admin/setcards')}}">Base Design</a></li>
            <li class="nav-item"><a class="nav-link" href="{{url('admin/setcards')}}">Finish Type</a></li>
          </ul>
      </li>
