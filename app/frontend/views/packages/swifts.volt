                    ...
                    <div class="col_two_fifth product-desc">
                        ...
                        <form class="cart nobottommargin clearfix" role="form" method="post" id="cartFormPackage" enctype='multipart/form-data'>
                            ...
                            <div id="accordion" role="tablist">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            <div class="row">
                                            {% for keys, values in baseCardDesign %}
                                                <div class="col-md-4 col-6">
                                                    <div>
                                                        <input id="radio-{{keys+10}}" class="radio-style finishTypeRadio" value="{{values.base_card_design_id}}" name="base_design_id" type="radio">
                                                        <label for="radio-{{keys+10}}" class="radio-style-3-label">
                                                            <img src="{{url('assets/base_design/'~values.base_card_image)}}" style="margin-top:-20px; margin-left:-20px;" />
                                                            <br/>
                                                            <small><b>{{values.base_card_title | capitalize}}</b></small>
                                                        </label>
                                                    </div>
                                                </div>
                                            {% endfor %}
                                    ...
                                    <div id="collapseTwo" class="collapse show" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="selectQuantityRow">Quantity</label>
                                                <div id="selectRowShowQty" class="hide">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse show" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            Choose one of our eight unique base designs for your cards.<br/>
                                            <div id="finishCardTypes"></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input id="input-5" name="card_designs[]" type="file" class="file-loading" data-max-file-size="50M" multiple /><br/>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-4 bottommargin">
                                                    <label for="production_time_1" class="radio-style-3-label">
                                                        5 day Production Time &#8358;0.00
                                                    </label><br/>
                                                    <input id="production_time_1" class="radio-style" name="production_time" type="radio" value="0">
                                                </div>
                                                <div class="col-lg-4 bottommargin">
                                                    <label for="production_time_2" class="radio-style-3-label">
                                                        48hrs Production Time &#8358;18,000.00
                                                    </label><br/>
                                                    <input id="production_time_2" class="radio-style" name="production_time" type="radio" value="18000">
                                                </div>
                                                <div class="col-lg-4 bottommargin">
                                                    <label for="production_time_3" class="radio-style-3-label">
                                                        24hrs Production Time &#8358;36,000.00
                                                    </label><br/>
                                                    <input id="production_time_3" class="radio-style" name="production_time" type="radio" value="36000">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group" style="padding-top:10px;">
                                ...
                                <textarea class="form-control" id="project_details" rows="3" name="project_details"></textarea>
                                <input type="hidden" name="file_list" />
                                <input type="hidden" name="quantity" id="quantityDerive" />
                                <input type="hidden" name="singleQty" id="singleQty" />
                            ...
                            <div class="product-price">
                                <ins>&#8358;<span id="price_tagged">0.00</span></ins>
                            ...
                            <button type="button" class="add-to-cart button nomargin">Add to cart</button>
                        </form>
