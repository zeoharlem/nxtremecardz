    ...
    <main class="main" id="top">
      ...
      <div class="container">
        ...
        <div class="row flex-center min-vh-100 py-6">
          ...
          <a class="d-block text-center mb-4" href="#"><img class="mr-2" src="{{ url('assets/extra/img/xtreme-logo-dark.png') }}" alt="" width="150" /><span class="text-sans-serif font-weight-extra-bold fs-5 d-inline-block"></span></a>
            {{ flash.output() }}
            <div class="card">
              <div class="card-body p-5">
                ...
                <form id="registerForm" method="POST" action="{{ url('backend/index/register/') }}">
