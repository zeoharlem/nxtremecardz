...
class Register extends BaseModel {
    ...
    public function afterCreate() {
        ...
        self::$_message = "An Account was successfully created for you. Username is your email and Password is Admin";
                     ...
                     <tr>
                        <td align=\"left\" valign=\"top\">
                           <font face=\"'Source Sans Pro', sans-serif\" color=\"#1a1a1a\" style=\"font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;\">
                              <span style=\"font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 42px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;\">Hey <b>".$this->email."</b>,</span>
                           </font>
