                            ...
                            <div class="fslider" data-pagi="false" data-arrows="false" data-thumbs="true">
                                <div class="flexslider">
                                    <div class="slider-wrap" data-lightbox="gallery">
                                        <div class="slide" data-thumb="<?= $this->url->get('assets/images/portfolio/4/2.jpg') ?>"><a href="<?= $this->url->get('assets/images/portfolio/full/2.jpg') ?>" title="Pink Printed Dress - Front View" data-lightbox="gallery-item"><img src="<?= $this->url->get('assets/images/portfolio/full/2.jpg') ?>" alt="Pink Printed Dress"></a></div>
                                        <div class="slide" data-thumb="<?= $this->url->get('assets/images/portfolio/4/3.jpg') ?>"><a href="<?= $this->url->get('assets/images/portfolio/full/3.jpg') ?>" title="Pink Printed Dress - Side View" data-lightbox="gallery-item"><img src="<?= $this->url->get('assets/images/portfolio/full/3.jpg') ?>" alt="Pink Printed Dress"></a></div>
                                        <div class="slide" data-thumb="<?= $this->url->get('assets/images/portfolio/4/4.jpg') ?>"><a href="<?= $this->url->get('assets/images/portfolio/full/4.jpg') ?>" title="Pink Printed Dress - Back View" data-lightbox="gallery-item"><img src="<?= $this->url->get('assets/images/portfolio/full/4.jpg') ?>" alt="Pink Printed Dress"></a></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col_two_fifth product-desc">
                        ...
                        <form class="cart nobottommargin clearfix" role="form" method="post" id="cartFormPackage" enctype='multipart/form-data'>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input id="heads_on_images" name="card_designs[]" type="file" class="file-loading" data-max-file-size="50M" multiple /><br/>
                                                </div>
                            ...
                            <div class="product-price">
                                ...
                                <input type="hidden" name="quantityDerive" id="quantityDerive" value="72000" />
                                <ins>&#8358;<span id="price_tagged" title="72000">72,000.00</span></ins>
                            ...
                            <button type="button" class="add-to-cart-heads button nomargin">Add to cart</button>
                        </form>
