        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div class="col_half">
                    <div class="card">
                        <div class="card-body">
                            Returning customer? <a href="<?= $this->url->get('login') ?>">Click here to login</a>
                        </div>
                    </div>
                </div>
                <?php
                ...
                <div class="col_half col_last">
                    <div class="card">
                        <div class="card-body">
                            <!--<a href="<?= $this->url->get('dashboard') ?>" class="button button-3d button-rounded button-amber"><i class="icon-ok"></i>Dashboard</a>-->
                            <a href="<?= $this->url->get('dashboard') ?>?token=<?php echo uniqid('xcR8'); ?>"><b>Dashboard</b></a>
                        </div>
                    </div>
                </div>
                <?php
