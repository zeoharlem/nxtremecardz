        ...
        "columnDefs": [
            {
                ...
                "render": function ( data, type, row, meta ) {
                    ...
                    return "<div class='btn-group'>" +
                        ...
                        "<a href='"+urlRowString+"/backend/projects/zipfile?project_id="+row['project_id']+"&project_title="+row['project_title']+"&setproject_id="+row['setproject_id']+"' class='zip btn btn-sm btn-danger "+zipFileRow+"'>Passport</a>"+
